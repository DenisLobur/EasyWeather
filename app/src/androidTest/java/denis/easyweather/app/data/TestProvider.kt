...
class TestProvider : AndroidTestCase() {
    ...
    fun deleteAllRecordsFromProvider() {
        mContext.contentResolver.delete(
                WeatherEntry.CONTENT_URI, null, null
        )
        mContext.contentResolver.delete(
                WeatherContract.LocationEntry.CONTENT_URI, null, null
        )
     ...
     */
        ...
        private val BULK_INSERT_RECORDS_TO_INSERT = 10
        internal fun createBulkInsertWeatherValues(locationRowId: Long): Array<ContentValues> {
            ...
            while (i < BULK_INSERT_RECORDS_TO_INSERT) {
                ...
                weatherValues.put(WeatherContract.WeatherEntry.COLUMN_HUMIDITY, 1.2 + 0.01 * i.toFloat())
                weatherValues.put(WeatherContract.WeatherEntry.COLUMN_PRESSURE, 1.3 - 0.01 * i.toFloat())
                ...
                weatherValues.put(WeatherContract.WeatherEntry.COLUMN_WIND_SPEED, 5.5 + 0.2 * i.toFloat())
