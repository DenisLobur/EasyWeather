...
import kotlinx.android.synthetic.main.view_input_field.view.error
import kotlinx.android.synthetic.main.view_input_field.view.input_field
import kotlinx.android.synthetic.main.view_input_field.view.label
    ...
    if (attrs != null) {
      ...
      for (i in 0 until n) {
        ...
        when (attr) {
          ...
          R.styleable.InputFieldView_android_inputType -> input_field.inputType =
            a.getInt(attr, EditorInfo.TYPE_TEXT_VARIATION_NORMAL)
          R.styleable.InputFieldView_android_imeOptions -> input_field.imeOptions =
            a.getInt(attr, 0)
