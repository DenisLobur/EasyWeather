...
sealed class Result<out T : Any> {
  ...
  sealed class Error : Result<Nothing>() {
    ...
    /**
     * Wrapper class for 4XX HTTP errors with additional data.
     * You must determine json schema as data class for this error
     */
    data class ComplexRequestError<E>(val errorMessage: ComplexErrorMessage<E>) : Error()
