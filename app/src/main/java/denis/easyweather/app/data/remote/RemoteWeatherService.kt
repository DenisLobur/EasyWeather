...
interface RemoteWeatherService {
    ...
    @GET("weather")
    fun requestWeatherForCityByCoordinates(@Query("lat") latitude: String, @Query("lon") longitude: String, @Query("APPID") apiKey: String, @Query("units") units: String): Single<WeatherResponse>
