...
import static denis.easyweather.app.database.WeatherContract.WeatherEntry;
...
public class FetchWeatherTask extends AsyncTask<String, Void, String[]> {
    ...
    private String getReadableDateString(long time){
        // Because the weatherService returns a unix timestamp (measured in seconds),
...
//            }
    ...
    protected String[] doInBackground(String... params) {
        ...
        try {
            ...
            // Possible parameters are avaiable at OWM's forecast weatherService page, at
